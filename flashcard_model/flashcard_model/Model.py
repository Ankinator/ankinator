...
class Model(ABC):
    ...
    def __call__(self, document_id: str, model_name: str, extracted_pages: List[Tuple[int, str, str, Image]]):
        model_result: List[Tuple[int, List[str]]] = self.model_forward(extracted_pages)
        add_model_result_to_document(document_id, model_name, model_result)
