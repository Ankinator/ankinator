...
def load_processed_pdf_document(result_id: str) -> fpdf.FPDF:
    extracted_pages = load_processed_data(result_id)
...
def load_processed_data(result_id: str):
    file_object = grid_fs.get_last_version(filename=result_id)
